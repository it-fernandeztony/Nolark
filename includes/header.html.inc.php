...
$pages = array(
   ...
   // 'Retour Portfolio' => 'https://it-fernandeztony.com/index.html'
);
?>
...
<header>
    ...
    <nav>
        ...
        <ul>
            ...
            <li>
            <div class="dropdown">
                <a class="dropbtn" href="#">Plus 
                    <i class="fa fa-caret-down"></i>
                </a>
                <div class="dropdown-content">
                    <a href="../pages/simulateur.php">Primes commerciaux</a>
                    <a href="../pages/livrexpress.php">Primes chauffeurs</a>
                    <a href="../pages/alcoolemie.php">Alcoolémie</a>
                    <a href="https://it-fernandeztony.com/index.html">Retour Portfolio</a>
                </div>
            </div> 
            </li>
        </ul>
